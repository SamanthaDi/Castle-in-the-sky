...
public class SecondLevelWorld extends Level
{
    ...
    public SecondLevelWorld(int timeLimit)
    {    
    ...
    public void act()
    {
        ...
        {
            stopSong();
            Greenfoot.setWorld(new FinalLevelWorld(120));
        }
